class AppwriteConstants {
  ...
  static const String endPoint =
      'http://192.168.88.196:80/v1'; //this helps flutter communicate with appwrite
  static const String usersCollection = '651238192ad37ed98e84';
  static const String tweetsCollection = '65185f7f1adbc9bcdea7';
  static const String notificationsCollection = '653d3442ddcee0bd881b';

  static const String imagesBucket = '651ae8155e91cec899e8';
  static String imageUrl(String imageId) =>
      'http://192.168.88.196:80/v1/storage/buckets/$imagesBucket/files/$imageId/view?project=$projectId&mode=admin';
}
