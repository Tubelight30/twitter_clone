...
class Tweet {
  ...
  @override
  String toString() {
    return 'Tweet(text: $text, hashtags: $hashtags, link: $link, imagesLinks: $imagesLinks, uid: $uid, tweetType: $tweetType, tweetedAt: $tweetedAt, likes: $likes, commentsIds: $commentsIds, id: $id, resharedCount: $resharedCount)';
  }
